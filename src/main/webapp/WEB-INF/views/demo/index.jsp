...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <style>
            ...
            /* 4. Chỉnh sửa khoảng cách giữa các section */
            .container-fluid#main-wrapper {
                padding-top: 120px; /* lùi xuống cho header cố định */
            }
            .event-detail-panel {
                opacity: 0;
            ...
            /* 2. Bao vùng chứa feed, để nổi bật so với background */
            .feed-wrapper {
                background: #ffffff;
                border-radius: 16px;
                padding: 40px;
            ...
            .event-card {
                ...
                margin-bottom: 24px;
                display: flex;
                align-items: center;      /* center ảnh + phần info */
                gap: 20px;                /* (tuỳ chọn) khoảng cách giữa ảnh & info */
                background: #fff;
                border-radius: 12px;
            ...
            .event-title {
                display: inline-block;           /* để padding và background chỉ ôm sát chữ */
                background-color: #e3f2fd;       /* nền xanh nhạt */
                color: #0d47a1;                  /* chữ xanh đậm */
                padding: 4px 8px;                /* khoảng đệm xung quanh */
                border-radius: 4px;              /* bo góc nhẹ */
                margin-bottom: 12px;             /* cách dưới tiêu đề */
            }
            .event-description {
                font-size: 14px;
                color: #555;
            ...
            .event-title:hover {
                background-color: #bbdefb; /* xanh nhạt hơn */
            }
        </style>
    </head>
                ...
                <div class="feed-wrapper w-100" style="max-width: 80%;">
                    ...
                    <div class="event-card" data-title="<%= event.getTieuDe()%>" data-category="<%= event.getTenDanhMuc()%>">
                        <img class="event-image"
                             src="${pageContext.request.contextPath}/uploads/<%= event.getHinhAnh()%>" 
                             width= "100" 
                             alt="Hình sự kiện" />
                        ...
                        <div class="event-info">
                            <div>
                                ...
                                <h3 class="event-description">Thể loại: <%= event.getTenDanhMuc()%></h3>
                            ...
                            <div class="event-action">
                                ...
                                %>
                                <div class="event-action">
                                    <a href="${pageContext.request.contextPath}/events/detail/<%= event.getMaSuKien()%>"
                                       class="btn btn-outline-primary me-2">
                                        Chi tiết
                                    </a>
                                    <a href="${pageContext.request.contextPath}/eventregister?suKienId=<%= event.getMaSuKien()%>"
